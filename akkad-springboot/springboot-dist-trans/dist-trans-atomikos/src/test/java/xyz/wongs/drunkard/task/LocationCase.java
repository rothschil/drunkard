...
import xyz.wongs.drunkard.service.JtaService;
...
public class LocationCase extends BaseTest {
    ...
    public void testGetById() throws Exception{
        mockMvc.perform(MockMvcRequestBuilders.get("/locations/getUrl")
                .param("id","143840")
    ...
    public void testGetById3() throws Exception{
        mockMvc.perform(MockMvcRequestBuilders.get("/locations/findByLocationId")
